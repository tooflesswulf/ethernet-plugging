...
from agent.utils.robot_utils import get_actions2, build_states, wait_for_circle
...
class EvalRealtimeChunking(robot_execution.RobotExecution):
    ...
    def runtime_info(self):
        print('Buffer size:', len(self.buffer._chunks), end='\r')
    ...
    def prediction_loop(self):
        ...
        while not self.stop_event.is_set():
            ...
            with torch.no_grad():
                des_poses, des_grips, des_done = get_actions2(self.policy, obs_deque, self.device)
