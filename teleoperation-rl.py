...
def eval_with_teleop(policy, log_dir=None, control_freq=20, device='cuda', weight_decay=2.0):
        ...
        while not stop_event.is_set():
            ...
            with torch.no_grad():
                des_poses, des_grips = get_actions(
                    policy, nimages, nobs_state, curr_pose, curr_gripper)
    ...
    try:
        ...
        while not stop_event.is_set():
            ...
            if action is None:
                ...
                # Joystick inputs as residual.
                des_pose = iface.residual_action(des_pose, control_dt)
